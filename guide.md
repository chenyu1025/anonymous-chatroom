# Anonymous Chatroom (Next.js + Supabase) - Trae 实战指南
...
*   **去哪找 Skill**:
    *   访问 ** `https://skillsmp.com/search` **。这里是 Skill 的大本营。
...
这是我们项目的全貌。生成自AI, 也应用于AI

![架构图](https://p0-bytetech-private.bytetech.info/tos-cn-i-93o7bpds8j/b8a80fb05f9147659420141e05f2dd36~tplv-93o7bpds8j-compressed.awebp?policy=eyJ2bSI6MiwiY2siOiJieXRldGVjaCJ9&rk3s=5aaa0ea2&x-orig-authkey=f32326d3454f2ac7e96d3d06cdbb035152127018&x-orig-expires=1770440562&x-orig-sign=FUWxlCkRsq1ueCChEzieCS8EJuw%3D)
...
### 7.1 怎么下载和安装
1.  **找 Skill**: 去 ** `https://skillsmp.com/search` ** 逛逛。
